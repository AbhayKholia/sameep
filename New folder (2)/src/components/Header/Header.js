            ...
            <div className='header-cnt-top fs-13 py-2 flex align-center justify-between'>
                <div className='header-cnt-top-l'>
                    <ul className='flex top-links align-center '>
                        ...
                        <ul className='social-link flex align-center'>
                            <li className='mx-2'>
                                <a href = "www.facebook.com" className='fs-15'><i className='fab fa-facebook'></i></a>
                            </li>
                            <li className='mx-2'>
                                <a href = "www.instagram.com" className='fs-15'><i className='fab fa-instagram'></i></a>
                            </li>
                        </ul>
                        </li>
                    </ul>
                ...
                <div className='header-cnt-top-r'>
                    <ul className='top-links flex align-center'>
                        ...
                        <li>
                            <Link to="/">
                                <span className='top-link-itm-txt'>Login
                                </span>
                            </Link>
                        </li>
                    </ul>
